...
ll n,k;
    ...
    fr(i,0,n){
        fr(j,i+1,n){
            ...
            string temp="";
            fr(kk,0,k){
                if(s1[kk]==s2[kk]) temp+=s1[kk];
                else{
                    if(s1[kk]=='S' && s2[kk]=='E') temp+='T';
                    else if(s1[kk]=='E' && s2[kk]=='S') temp+='T';
                    else if(s1[kk]=='E' && s2[kk]=='T') temp+='S';
                    else if(s1[kk]=='T' && s2[kk]=='E') temp+='S';
                    else if(s1[kk]=='S' && s2[kk]=='T') temp+='E';
                    else temp+='E';
                }
            }
            ans+=mm[temp];
